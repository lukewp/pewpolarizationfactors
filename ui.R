    ...
    tabItems(
      tabItem(
        ...
        fluidRow(box(
          ...
          tags$h3("Why factors?"),
          HTML("
               <p>These three groups were detected using a statistical technique called Matrix Factorization (specifically, a strategy called Non-negative Matrix Factorization or 'NMF' for short). NMF is a tool to uncover hidden connections and categories within big piles of information and has many uses from cybersecurity to genetics. Most notably, companies like Netflix, Amazon, and Spotify use NMF to figure out new ways to put movies, books, and songs together based on the shared interests of the people who like them. That helps them make intelligent recommendations for their customers based on an analysis of all the people whose likes are similar. So for example, a fan of Harry Potter films might be more likely to get a recommendation to watch Percy Jackson than The Highlander, even though all three would've been on the same 'Fantasy' shelf at Blockbuster. NMF is also great at identifying communities where dividing lines aren't so clear, which is why it's appropriate for this project.</p>
               <p>Political commentators often describe the U.S. as highly polarized. But it's important to recognize most Americans express characteristics of all three of these values groups. The individuals surveyed were plotted against each of these three values groups' definitions in the chart below. People whose survey responses demonstrate group purity would be plotted in the corners of the triangle. But the vast majority of plotted survey responses are scattered throughout the middle of the triangle. This project is described as a 'Factor Study' and not a 'Cluster Study,' because clusters imply a more clear-cut belonging to one group but not the others, and that's just not what's happening here. Americans express our values through some blend of all three factors.</p>
              "),
        ...
        fluidRow(box(
          ...
          tags$h3("So what?"),
          HTML("
               <p>If you represent one of these groups and aspire to build a working majority, the first thing to do is recognize there are three distinct groups and you'll have to find common ground with members of at least one of them to be successful. The following is a set of strategic scenarios for combining two groups to form a majority at the expense of the other:</p>
               <h4>Group 1 + Group 2: The Green Coalition</h4>
               <p>United in opposition to the third group, you have some common ground: You both mostly have an unfavorable view of the Republican Party, and Congress, and a favorable view of Labor Unions, the Federal Reserve, and the EPA. You believe that diplomacy is more effective than military strength for ensuring peace and that relying on military force can create hatred leading to increased terrorism. You believe too much power is concentrated in the hands of a few large companies. You both believe businesses make too much profit. You don't view MSNBC disfavorably. You both think the Republican party doesn't care about the middle class, and is too willing to cut government programs even when they work. You think the country should do whatever it takes to protect the environment, though you don't agree on all the tradeoffs of environmental protection. You both think sometimes laws are necessary to protect people from themselves. You think the American economic system unfairly favors powerful interests, that Wall Street hurts the economy as much as it helps. You agree the police should not be able to stop and search people for appearing suspicious. You believe in global warming, and attribute it to the burning of fossil fuels. You think we should invest more in renewable energy than in expanding exploration of coal, oil, and natural gas. You both support Common Core education standards. While you disagree on Obamacare, you agree that elected officials should do as much as possible to make it work now that it's law. You think Affirmative Action programs on college campuses are a good thing. You're both younger than Factor 3 and more diverse.</p>
               <h4>Group 3 + Group 2: The Orange Coalition</h4>
               <p>United in opposition to the first group, you have some common ground: You both mostly disapproved of President Obama's presidency and are dissatisfied by the way things are going in America today, and you think America's best years are behind us. You would prefer to live in a small town or rural area before a city, preferring a community where the houses are larger and farther apart, with schools, stores, and restaurants several miles away. It's not important to you to live in a place with a mix of people from different racial and ethnic backgrounds, or near art museums and theaters. You both view the Democratic Party and Congress unfavorably. You have a favorable view of the NRA, and you think both the Democratic and Republican parties' policies are misguided and a threat to the nation's well-being. You think government is almost always wasteful and inefficient, and that government regulation of business usually does more harm than good. You think poor people today have it easy because they get government benefits without having to do anything in return, and you don't think the government can afford to do much more to help the needy. You agree that Blacks who can't get ahead in this country are mostly responsible for their own condition. You think society is better off if people make marriage and children a priority. You think America has been successful because of its reliance on long-standing principles. You'd be very unhappy if an immediate family member said they were marrying an atheist. You both view Fox News favorably. You think the Democratic Party doesn't care about the middle class, and too often sees Government as the only way to solve problems. You think America has made the changes needed to give blacks equal rights with whites. You think government is doing too many things better left to businesses and individuals. You agree that government aid to the poor does more harm than good because it makes people too dependent on government assistance. You think Islam is more likely than other religions to encourage violence among its followers. You think the Supreme Court should base its rulings on what the U.S. Constitution meant as originally written. You oppose letting gays and lesbians marry. You both disapprove of Obamacare; you think the it's not the federal government's job to ensure all Americans have health coverage, that instead health coverage should be provided through a mix of private insurance and government programs. You think the government should protect individuals' rights to own guns. You think abortion should be illegal. You both attend religious services much more often, and more regularly than those in Group 1.</p>
               <h4>Group 1 + Group 3: The Purple Coalition</h4>
               <p>United in opposition to the second group, you have some common ground: You have an unfavorable opinion of Congress. You believe immigrants strengthen our country because of their hard work and talents. You believe problems in the world would be even worse without U.S. involvement. You think there are no real limits to growth in America today, and that as Americans we can always find ways to solve our problems and get what we want. You think homosexuals should be accepted by society. You're personally satisfied with your financial situation and find paying the bills generally pretty easy. You agree it is not necessary to believe in God to be moral and have good values. You think the growing number of newcomers from other countries strengthens American society. You also like elected officials who can compromise with those they disagree with. You think trade agreements between the US and other countries have been a good thing. You're significantly more likely to have attended college than those from Group 2.</p>
               <h4>Standing in one corner, speaking to another</h4>
               <p>One way to build a coalition is to communicate a platform of shared values like those described above. The more often-used approach is for a winning candidate to be of one group and speak to another while boxing his or her opponent into the third: President Barack Obama's biography placed him firmly in Group 1, but his often-sermonlike rhetoric spoke directly to Group 2. Presidents George W. Bush and Donald Trump both carried biographies placing them in Group 3, but with narratives of compassionate conservativism and isolationism respectively, their rhetoric spoke to Group 2. One could argue this approach of being one thing and saying another has stoked resentment and disillusionment among those in Group 2 towards each major party and government as a whole.</p>
               "))),
        fluidRow(box(
          width = 12,
